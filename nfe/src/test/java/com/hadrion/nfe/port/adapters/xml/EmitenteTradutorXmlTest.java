...
public class EmitenteTradutorXmlTest extends AbstractXmlTest {
	...
	private static final String XML = "<emit>\r\n"
	...
	public void setUp() {
		...
		emitente = new Emitente(new Cnpj(891206000310L), null,
				"NF-E EMITIDA EM AMBIENTE DE HOMOLOGACAO - SEM VALOR FISCAL",
				"COOPROESTE", new Endereco("RODOVIA BR 020 KM 449", "S/N",
						"F.ASA BRAN", "RODA VELHA", new Municipio(2928901,
								"SAO DESIDERIO", Uf.BA), Pais.BRASIL, new Cep(
								47820000), new Telefone("7736842141")), null,
				new InscricaoEstadual("43619043"), null, Crt.REGIME_NORMAL);
	}
