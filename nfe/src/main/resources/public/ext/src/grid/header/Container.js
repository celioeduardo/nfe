...
Ext.define('Ext.grid.header.Container', {
        ...
        if (headerEl && !me.ddLock) {
            ...
            if (header) {
                ...
                if (e.within(targetEl)) {
                    if (e.type === 'click' || e.type === 'tap' || (e.type === 'keydown' && e.getKey() === e.SPACE)) {
    ...
    onHeaderShow: function (header) {
        ...
        if (!header.isGroupHeader) {
            me.ownerCt.onHeaderShow(me, header);
        }
    ...
    onHeaderHide: function (header) {
        ...
        if (!header.isGroupHeader) {
            me.ownerCt.onHeaderHide(me, header);
        }
...
//        }
    ...
    getVisibleGridColumns: function() {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (!column.hidden && !column.isHierarchicallyHidden()) {
