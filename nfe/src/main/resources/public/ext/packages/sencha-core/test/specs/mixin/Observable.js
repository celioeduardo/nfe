describe("Ext.mixin.Observable", function() {
            ...
            describe("element " + (delegated ? "(with delegated listeners)" : "(with direct listeners)"), function() {
                ...
                describe("addListener", function() {
                    it("should handle an event", function() {
                        ...
                        expect(args[2]).toEqual({ delegated: delegated, translate: false });
                    ...
                    it("should attach listeners with a delegate selector as a direct child", function() {
    ...
    describe("declarative listeners", function() {
        ...
        it("should default to the class when resolving names", function() {
            var spy = jasmine.createSpy();
